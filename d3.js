...
(function (global, factory) {
  ...
  function set(object, f) {
    ...
    // Otherwise, assume itÃ¢â‚¬â„¢s an array.
    else if (object) {
...
var   tau$1 = 2 * pi$1;
  ...
  Path.prototype = path.prototype = {
    ...
    arc: function(x, y, r, a0, a1, ccw) {
      ...
      // Is this arc empty? WeÃ¢â‚¬â„¢re done.
      if (!r) return;
  ...
  function tree_cover(x, y) {
    ...
    // the existing quadrant boundaries donÃ¢â‚¬â„¢t change due to floating point error!
    if (isNaN(x0)) {
  ...
  function tree_find(x, y, radius) {
    ...
    while (q = quads.pop()) {
      ...
      // Stop searching if this quadrant canÃ¢â‚¬â„¢t contain a closer node.
      if (!(node = q.node)
          || (x1 = q.x0) > x3
          || (y1 = q.y0) > y3
          || (x2 = q.x1) < x0
      ...
      // Visit this point. (Visiting coincident points isnÃ¢â‚¬â„¢t necessary!)
      else {
  ...
  function arc() {
    ...
    function arc() {
      ...
      // Or is it a circular or annular sector?
        ...
        // Apply padding? Note that since r1 Ã¢â€°Â¥ r0, da1 Ã¢â€°Â¥ da0.
        if (rp > epsilon$1) {
        ...
        // Does the sectorÃ¢â‚¬â„¢s outer ring have rounded corners?
        ...
        // Is there no inner ring, and itÃ¢â‚¬â„¢s a circular sector?
        // Or perhaps itÃ¢â‚¬â„¢s an annular sector collapsed due to padding?
        if (!(r0 > epsilon$1) || !(da0 > epsilon$1)) context.lineTo(x10, y10);

        // Does the sectorÃ¢â‚¬â„¢s inner ring (or point) have rounded corners?
  ...
  // "you can express cubic Hermite interpolation in terms of cubic BÃƒÂ©zier curves
  ...
  function request(url, callback) {
    ...
    request = {
      ...
      // Alias for send("GET", Ã¢â‚¬Â¦).
      get: function(data, callback) {
        return request.send("GET", data, callback);
      },

      // Alias for send("POST", Ã¢â‚¬Â¦).
  ...
  function timerFlush() {
    ...
    ++frame; // Pretend weÃ¢â‚¬â„¢ve set an alarm, if we havenÃ¢â‚¬â„¢t already.
    var t = taskHead, e;
    while (t) {
...
var   t1$1 = new Date;
  ...
  function formatDecimal(x, p) {
    if ((i = (x = p ? x.toExponential(p - 1) : x.toExponential()).indexOf("e")) < 0) return null; // NaN, Ã‚Â±Infinity
    ...
    function newFormat(specifier) {
      ...
      function format(value) {
        ...
        if (type === "c") {
          ...
          // Break the formatted value into the integer Ã¢â‚¬Å“valueÃ¢â‚¬Â part that can be
          // grouped, and fractional or exponential Ã¢â‚¬Å“suffixÃ¢â‚¬Â part that is not.
          if (maybeSuffix) {
            i = -1, n = value.length;
            while (++i < n) {
...
var   durationWeek$1 = durationDay$1 * 7;
  ...
  var keyPrefix = "$"; // Protect against keys like Ã¢â‚¬Å“__proto__Ã¢â‚¬Â.
  ...
  function bindIndex(parent, group, enter, update, exit, data) {
    ...
    // Put any non-null nodes that donÃ¢â‚¬â„¢t fit into exit.
    for (; i < groupLength; ++i) {
      if (node = group[i]) {
        exit[i] = node;
      }
  ...
  function tweenRemove(id, name) {
    ...
    return function() {
      ...
      // just assign the updated shared tween and weÃ¢â‚¬â„¢re done!
  ...
  function onFunction(id, name, listener) {
    ...
    return function() {
      ...
      // just assign the updated shared dispatch and weÃ¢â‚¬â„¢re done!
      // Otherwise, copy-on-write.
...
var   epsilon$2 = 1e-6;
  ...
  function node_links() {
    ...
    root.each(function(node) {
      if (node !== root) { // DonÃ¢â‚¬â„¢t include the rootÃ¢â‚¬â„¢s parent, if any.
  ...
  function packEnclose(circles) {
    ...
    // Attempt to place each remaining circleÃ¢â‚¬Â¦
    pack: for (i = 3; i < n; ++i) {
      place(a._, b._, c = circles[i]), c = new Node$1(c);

      // If there are only three elements in the front-chainÃ¢â‚¬Â¦
...
var   keyPrefix$1 = "$";
  ...
  // If vi-Ã¢â‚¬â„¢s ancestor is a sibling of v, returns vi-Ã¢â‚¬â„¢s ancestor. Otherwise,
  ...
  function tree() {
    ...
    function tree(root) {
      ...
      // Compute the layout using Buchheim et al.Ã¢â‚¬â„¢s algorithm.
  ...
  // LiangÃ¢â‚¬â€œBarsky line clipping.
  ...
  function clipCells(x0, y0, x1, y1) {
    ...
    // If there werenÃ¢â‚¬â„¢t any edges, have the closest site cover the extent.
    // It doesnÃ¢â‚¬â„¢t matter which corner of the extent we measure!
    if (cover) {
  ...
  function zoom() {
    ...
    function wheeled() {
      ...
      // If this wheel event wonÃ¢â‚¬â„¢t trigger a transform change, ignore it.
  ...
  // Like d3.local, but with the name Ã¢â‚¬Å“__brushÃ¢â‚¬Â rather than auto-generated.
  ...
  function areaPoint(lambda, phi) {
    ...
    // previous point, current point.  Uses a formula derived from CagnoliÃ¢â‚¬â„¢s
...
var   range$1;
  ...
  // This is almost the same as (lambda1 - lambda0 + 360Ã‚Â°) % 360Ã‚Â°, except that we want
  // the distance between Ã‚Â±180Ã‚Â° to be 360Ã‚Â°.
...
var   phi00$2;
  ...
  // Generates a circle centered at [0Ã‚Â°, 0Ã‚Â°], with a given radius and precision.
  ...
  var clipMax = 1e9;
  var clipMin = -clipMax;
  // TODO Use d3-polygonÃ¢â‚¬â„¢s polygonContains here for the ring check?
...
var   y0$3;
  ...
  function polygonContains(polygon, point) {
    ...
    for (var i = 0, n = polygon.length; i < n; ++i) {
      ...
      for (var j = 0; j < m; ++j, lambda0 = lambda1, sinPhi0 = sinPhi1, cosPhi0 = cosPhi1, point0 = point1) {
        ...
        // Are the longitudes either side of the pointÃ¢â‚¬â„¢s meridian (lambda),
  ...
  function clipCircle(radius, delta) {
    ...
    function intersect(a, b, two) {
      ...
      // Find intersection line p(t) = c1 n1 + c2 n2 + t (n1 Ã¢Â¨Â¯ n2).
      var n1 = [1, 0, 0], // normal
  ...
  // 960Ãƒâ€”500. Also works quite well at 960Ãƒâ€”600 with scale 1285. The set of
